...
package com.zh.android.swipemenulayoutsample.widget;
 ...
 */
public class CoVerticalTextView extends androidx.appcompat.widget.AppCompatTextView {
    /**
     * 是否将文字显示成竖排
     */
    ...
    public CoVerticalTextView(Context context) {
        super(context);
        init();
    }

    public CoVerticalTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CoVerticalTextView(Context context, AttributeSet attrs, int defStyleAttr) {
